...
namespace PlanesVentas.Infraestructura.Adaptadores.RepositorioGenerico
{
    ...
    public class RepositorioBase<T> : IRepositorioBase<T> where T : class
    {
        ...
        private PlanesVentasDbContext GetContext()
        {
            return _serviceProvider.GetService<PlanesVentasDbContext>();
        }
